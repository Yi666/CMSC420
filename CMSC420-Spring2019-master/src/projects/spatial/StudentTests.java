...
public class StudentTests {
    ...
    public void testKDTreeFewInsertions(){
        ...
        kdTree.insert(new KDPoint(-20, 300));
        //kdTree.delete(new KDPoint(-20,300));
        //System.out.println(kdTree.count());

        KDPoint a = new KDPoint(1,1);
        KDPoint b = new KDPoint(1,1);
...
/*        //assertEquals("The first point inserted should be our root.", new KDPoint(10, 30), kdTree.getRoot());
        ...
        assertEquals("The number of nodes in this tree should be 3.", 1, kdTree.count());*/
    }
...
/*                System.out.println(p);
                System.out.println(Math.sqrt(p.distanceSquared(originInDim)) + EPSILON);*/
    ...
    public void testSimpleQuadTree(){
        ...
        prQuadTree.insert(new KDPoint(-1,-1));
        prQuadTree.insert(new KDPoint(-3,-1));
        prQuadTree.insert(new KDPoint(-2,-1));

        System.out.println(prQuadTree.height());
