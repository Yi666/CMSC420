...
public interface PriorityQueue<T> extends Iterable<T>{
	 ...
	 * Euclidean Distances in KNN queries. In that context, a smaller distance (from some pre-determined point) will be
	 * considered "better", so a higher priority will be attached. </p>
	 *
	 * @param element The element to insert in the queue.
	 * @param priority The priority of the element. Smaller is better.
	 *
